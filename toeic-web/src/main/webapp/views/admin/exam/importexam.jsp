...
<c:url var="validateExcel" value="/admin-exam-import-validate.html"/>
<c:url var="importExcel" value="/admin-exam-import.html"/>
<html>
<head>
    ...
    <div class="main-content-inner">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><fmt:message key="label.exam.import.excel" bundle="${lang}"/></li>
            </ul><!-- /.breadcrumb -->
        </div>
                    ...
                    <form action="${validateExcel}" method="post" enctype="multipart/form-data" id="formImport">
                        ...
                        <c:if test="${not empty items.examinationQuestionImportDTOS}">
                            ...
                            <button type="button" class="dt-button buttons-html5 btn btn-white btn-primary btn-bold" id="importData">
                                <fmt:message key="label.exam.import" bundle="${lang}"/>
                            </button>
                        </c:if>
