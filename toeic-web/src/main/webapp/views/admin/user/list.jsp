                        ...
                        <fmt:bundle basename="ResourcesBundle">
                            <display:table id="tableList" name="items.listResult" partialList="true" size="${items.totalItems}"
                                ...
                                <display:column headerClass="col-actions" titleKey="label.action">
                                    ...
                                    <c:url var="deleteUrl" value="/admin-user-delete.html">
                                        <c:param name="urlType" value="url_list"/>
                                        <c:param name="pojo.userId" value="${tableList.userId}"/>
                                        <c:param name="crudaction" value="redirect_delete"/>
                                    </c:url>
                                    <a class="btn btn-sm btn-danger btn-cancel" href="${deleteUrl}" data-toggle="tooltip" title="<fmt:message key='label.user.delete' bundle='${lang}'/>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                </display:column>
                            </display:table>
                        </fmt:bundle>
                    </div>
